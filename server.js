...
const ALLOWED_UPSTREAM_HOSTS = new Set([
  ...
  "asia-east1-aiplatform.clients6.google.com",
  "asia-east2-aiplatform.clients6.google.com",
  "asia-northeast1-aiplatform.clients6.google.com",
  "asia-northeast3-aiplatform.clients6.google.com",
  "asia-south1-aiplatform.clients6.google.com",
  "asia-southeast1-aiplatform.clients6.google.com",
  "australia-southeast1-aiplatform.clients6.google.com",
  "europe-central2-aiplatform.clients6.google.com",
  "europe-north1-aiplatform.clients6.google.com",
  "europe-southwest1-aiplatform.clients6.google.com",
  "europe-west1-aiplatform.clients6.google.com",
  "europe-west2-aiplatform.clients6.google.com",
  "europe-west3-aiplatform.clients6.google.com",
  "europe-west4-aiplatform.clients6.google.com",
  "europe-west6-aiplatform.clients6.google.com",
  "europe-west8-aiplatform.clients6.google.com",
  "europe-west9-aiplatform.clients6.google.com",
  "global-aiplatform.clients6.google.com",
  "me-central1-aiplatform.clients6.google.com",
  "me-central2-aiplatform.clients6.google.com",
  "me-west1-aiplatform.clients6.google.com",
  "northamerica-northeast1-aiplatform.clients6.google.com",
  "southamerica-east1-aiplatform.clients6.google.com",
  "us-central1-aiplatform.clients6.google.com",
  "us-east1-aiplatform.clients6.google.com",
  "us-east4-aiplatform.clients6.google.com",
  "us-east5-aiplatform.clients6.google.com",
  "us-south1-aiplatform.clients6.google.com",
  "us-west1-aiplatform.clients6.google.com",
  "us-west4-aiplatform.clients6.google.com",
]);
...
app.post('/api-proxy', async (req, res) => {
  // IMPORTANT: Vertex AI Studio Security Validation
  // Removing or altering this code will expose your backend APIs to unauthorized
  // access and unexpected costs.
  if (SECRET_KEY) {
...
server.on('upgrade', async (request, socket, head) => {
  ...
  if (url.pathname === '/ws-proxy') {
    ...
    if (SECRET_KEY) {
      ...
      if (clientKey !== SECRET_KEY) {
        console.log('[Node Proxy] Invalid secret key');
